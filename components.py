...
class TransportFormApp:
    def __init__(self, root):
        ...
        self.codBarra_entry = self.create_label_entry("Codigo de Barras:", 2, self.codBarra_var)
        self.numero_entry = self.create_label_entry("Numero de Cte:", 3, self.numero_var)
        ...
        self.button_cadastrar.grid(row=8, column=2, padx=10, pady=10)

        self.button_consultar = tk.Button(self.container, text="Consultar", command=self.consultar)
        self.button_consultar.grid(row=8, column=1, padx=10, pady=10)

        self.button_atualizar = tk.Button(self.container, text="Atualizar", command=self.atualizar)
        self.button_atualizar.grid(row=8, column=0, padx=10, pady=10)
